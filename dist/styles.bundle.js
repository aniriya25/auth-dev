...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../css-loader/index.js??ref--8-1!../../../../postcss-loader/index.js??postcss!./icons.css", function() {
			var newContent = require("!!../../../../css-loader/index.js??ref--8-1!../../../../postcss-loader/index.js??postcss!./icons.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../css-loader/index.js??ref--8-1!../../../postcss-loader/index.js??postcss!./index.css", function() {
			var newContent = require("!!../../../css-loader/index.js??ref--8-1!../../../postcss-loader/index.js??postcss!./index.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../css-loader/index.js??ref--8-1!../../../../postcss-loader/index.js??postcss!./material.css", function() {
			var newContent = require("!!../../../../css-loader/index.js??ref--8-1!../../../../postcss-loader/index.js??postcss!./material.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
__webpack_require__("../../../material/prebuilt-themes/indigo-pink.css");
...
__webpack_require__("../../../../@swimlane/ngx-datatable/release/assets/icons.css");
