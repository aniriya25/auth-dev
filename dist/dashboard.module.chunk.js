...
var DashboardMenuComponent = /** @class */ (function () {
    function DashboardMenuComponent(loginService, router, userProfile, providerService) {
        ...
        this.InvoiceOutlet = false;
        this.InvoiceAccount = true;
    ...
    DashboardMenuComponent.prototype.getUserProviderProfile = function () {
        var _this = this;
    ...
    // }
    // }
    DashboardMenuComponent.prototype.showModule = function () {
    ...
    DashboardMenuComponent.prototype.getUserProfile = function () {
        ...
        this.userProfile.getPersonalInfo()
            ...
            console.log(_this.profile.refProfileLoginId);
            _this.showModule();
        });
    };
    ...
    DashboardMenuComponent.prototype.selectedIndexChange = function (val) { };
    DashboardMenuComponent.prototype.selectId = function (id) {
        this.selected = id;
    };
