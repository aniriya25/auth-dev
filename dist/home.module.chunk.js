...
var GenerateTransactionComponent = /** @class */ (function () {
    ...
    GenerateTransactionComponent.prototype.getTransaction = function () {
        this._route.navigate(['dashboard/transactions'], { queryParams: { page: this.user.crdNo } });
    };
