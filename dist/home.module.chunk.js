...
var GenerateTransactionComponent = /** @class */ (function () {
    function GenerateTransactionComponent(fb) {
        this.fb = fb;
    }
    GenerateTransactionComponent.prototype.ngOnInit = function () {
        this.form = this.fb.group({
            codeType: [null, __WEBPACK_IMPORTED_MODULE_0__angular_forms__["j" /* Validators */].required],
            cardNumber: [null, __WEBPACK_IMPORTED_MODULE_0__angular_forms__["j" /* Validators */].required]
        });
    };
