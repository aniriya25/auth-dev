...
var ReviewComponent = /** @class */ (function () {
    function ReviewComponent(dialogRef, data, _transaction, snackBar, _route, _profile) {
        ...
        this.user.couponCode = this.data.couponCode;
...
var SummaryComponent = /** @class */ (function () {
    ...
    function SummaryComponent(dialogRef, data, _transaction, snackBar, _route, _profile) {
        ...
        this.sdata = [];
        this.totalAmount = 0;
        this.totalUserPaidAmount = 0;
        this.totalPromisedAmount = 0;
        this.saveData = {};
        //debugger;
        this.allrows = this.rows;
        this.rows = this.data[0];
    }
    SummaryComponent.prototype.getids = function (id) {
    ...
    SummaryComponent.prototype.saveDataFunction = function () {
        var _this = this;
        ...
        this._transaction.transactionPost(this.saveData)
            ...
            if (res && res.message) {
                ...
                _this.dialogRef.close();
                _this._route.navigate(['dashboard/invoices/invoices-list']);
            }
...
var TransactionListComponent = /** @class */ (function () {
    function TransactionListComponent(_alltransaction, dialog, snackBar) {
    ...
    TransactionListComponent.prototype.getFilterData = function (value) {
        var _this = this;
        //debugger;
        //alert('ok');     
        this.strdate = __WEBPACK_IMPORTED_MODULE_4_moment__(this.userData.strdate).format('DD-MMM-YYYY');
        this.endDate = __WEBPACK_IMPORTED_MODULE_4_moment__(value).format('DD-MMM-YYYY');
    ...
    TransactionListComponent.prototype.updateFilter = function (event) {
    ...
    TransactionListComponent.prototype.selectedIndexChange = function (val) {
        if (val === 0) {
            this.getTransctionData();
        }
        else if (val === 1) {
...
var TransactionComponent = /** @class */ (function () {
    ...
    TransactionComponent.prototype.getTrasnctionData1 = function () {
        ...
        if (this.user.cardNumber.length == 6) {
            this._transaction.getCouponTransaction(this.user.cardNumber)
                ...
                _this.user.couponCode = data.data["couponCode"];
                _this.user.refCardId = data.data["refCardId"];
                _this.user.cardNumber = data.data["cardNumber"];
                _this.route.queryParams.subscribe(function (queryParams) { return _this.user.requestNo = queryParams['page']; });
    ...
    TransactionComponent.prototype.showMember = function () {
        this.Membershow = true;
    };
    TransactionComponent.prototype.edittotal = function () {
        this.showotp = false;
        this.detailspay = false;
        this.button = true;
        this.user.otp = "";
    ...
    TransactionComponent.prototype.handleFileSelect = function (evt) {
    ...
    TransactionComponent.prototype._handleReaderLoaded = function (readerEvt) {
