...
var TransactionComponent = (function () {
    ...
    TransactionComponent.prototype.getTrasnctionData = function () {
        ...
        this._transaction.getTransaction(this.abc)
            ...
            console.log(_this.user.cardNumber);
        });
    };
