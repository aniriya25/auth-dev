...
var TransactionListComponent = /** @class */ (function () {
    ...
    TransactionListComponent.prototype.getFilterData = function () {
        var _this = this;
        debugger;
        this.strdate = __WEBPACK_IMPORTED_MODULE_4_moment__(this.userData.strdate).format('DD-MMM-YYYY');
        this.endDate = __WEBPACK_IMPORTED_MODULE_4_moment__(this.userData.endDate).format('DD-MMM-YYYY');
